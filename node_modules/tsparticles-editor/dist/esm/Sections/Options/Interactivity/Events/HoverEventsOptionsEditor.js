...
export class HoverEventsOptionsEditor extends EditorBase {
    ...
    addParallax() {
        ...
        parallax.addProperty("enable", "Enable", EditorType.boolean).change(() => __awaiter(this, void 0, void 0, function* () {
            yield particles.refresh();
        }));
        parallax.addProperty("force", "Force", EditorType.number).change(() => __awaiter(this, void 0, void 0, function* () {
            yield particles.refresh();
        }));
        parallax.addProperty("smooth", "Smooth", EditorType.number).change(() => __awaiter(this, void 0, void 0, function* () {
            yield particles.refresh();
        }));
    }
    addProperties() {
