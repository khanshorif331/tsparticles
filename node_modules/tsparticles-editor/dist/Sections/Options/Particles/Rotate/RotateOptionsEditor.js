...
export class RotateOptionsEditor extends EditorBase {
    ...
    addProperties() {
        ...
        this.group.addProperty("path", "Path", EditorType.boolean).change(() => __awaiter(this, void 0, void 0, function* () {
            yield particles.refresh();
        }));
        this.group.addProperty("random", "Random", EditorType.boolean).change(() => __awaiter(this, void 0, void 0, function* () {
            yield particles.refresh();
        }));
